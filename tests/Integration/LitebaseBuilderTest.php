...
describe('LitebaseBuilder', function () {
    it('is an instance of LitebaseBuilder', function () {
        ...
        $builder = DB::connection('litebase')->getSchemaBuilder();
    ...
    test('dropIfExists', function () {
        ...
        $builder->dropIfExists('test_drop_if_exists_table');
        $builder->dropIfExists('non_existent_table');
    ...
    test('dropAllViews', function () {
        ...
        // Create a view
        DB::connection('litebase')->statement('CREATE VIEW test_view AS SELECT * FROM test_view_table');
    ...
    test('dropColumns', function () {
        ...
        $builder->dropColumns('test_drop_columns_table', ['email']);
    ...
    test('getViews', function () {
        ...
        // Create a view
        DB::connection('litebase')->statement('CREATE VIEW test_get_views AS SELECT * FROM test_get_views_table');
    ...
    test('hasView', function () {
        ...
        // Create a view
        DB::connection('litebase')->statement('CREATE VIEW test_has_view AS SELECT * FROM test_has_view_table');
    ...
    test('rename', function () {
        ...
        $builder->rename('test_rename_table', 'renamed_table');
    ...
    test('table', function () {
        ...
        $builder->table('test_table_method', function (Blueprint $table) {
            $table->string('email');
        });
